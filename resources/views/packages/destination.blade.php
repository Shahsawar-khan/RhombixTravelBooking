...
@section('title', $destination->name . ' Packages | TravelEase')
    ...
    <div class="packages-hero">
        ...
        <div class="packages-hero-content">
            ...
            <span class="packages-eyebrow">
                EXPLORE {{ strtoupper($destination->name) }}
            </span>
            ...
            <p>
                Choose the perfect package and make your
                {{ $destination->name }} journey unforgettable.
            </p>
                    ...
                    <article class="package-card">
                        ...
                        <div class="package-content">
                            ...
                            <div class="package-bottom">
                                ...
                                <a href="{{ route('packages.show', $package) }}" class="package-button">
                                        View Details →
                                </a>
